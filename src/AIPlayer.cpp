                   ...
                   int last_action, int current_pot, int state)
{
    ...
    try
    {
        ...
        if(action_set.size() != 0)
        {
            ...
            /*
            input_hand.push_back(OneHotEncode(pocket_cards()[0].rank()-1, 13));
            input_hand.push_back(OneHotEncode(pocket_cards()[0].suit()-1, 4));
            input_hand.push_back(OneHotEncode(pocket_cards()[1].rank()-1, 13));
            input_hand.push_back(OneHotEncode(pocket_cards()[1].suit()-1, 4));
            */
            ...
            //    rec_self_act.push_back(OneHotEncode(action_history()[action_history().size()-1], 5));
            ...
            //if(opponent_history.size()!= 0)
            //    rec_opp_act.push_back(OneHotEncode(opponent_history[opponent_history.size()-1], 5));
